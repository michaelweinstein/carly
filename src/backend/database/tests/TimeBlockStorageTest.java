...
public class TimeBlockStorageTest {
	...
	public void replaceUnavailableBlocks() {
		...
		UnavailableBlock unavailable1 = new UnavailableBlock(
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(2, TimeUnit.HOURS)), 
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(5, TimeUnit.HOURS)), 
				null); 
		UnavailableBlock unavailable2 = new UnavailableBlock(
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(13, TimeUnit.HOURS)), 
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(15, TimeUnit.HOURS)),  
				null); 
		UnavailableBlock unavailable3 = new UnavailableBlock(
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(25, TimeUnit.HOURS)), 
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(26, TimeUnit.HOURS)), 
				null);
		UnavailableBlock unavailable4 = new UnavailableBlock(
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(50, TimeUnit.HOURS)), 
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(55, TimeUnit.HOURS)), 
				null); 
		UnavailableBlock unavailable5 = new UnavailableBlock(
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(103, TimeUnit.HOURS)), 
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(107, TimeUnit.HOURS)),
				null); 
		UnavailableBlock unavailable6 = new UnavailableBlock(
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(126, TimeUnit.HOURS)), 
				new Date(msWeekStart + TimeUnit.MILLISECONDS.convert(131, TimeUnit.HOURS)),
				null); 
		...
		System.out.println(StorageService.getAllUnavailableBlocksWithinRange(weekStart, weekEnd));
