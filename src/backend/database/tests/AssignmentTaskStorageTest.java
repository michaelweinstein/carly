...
public class AssignmentTaskStorageTest {
	...
	public void addAssignments() {
		...
		final Task task11 = new Task("Task1 in " + assignment1.getName(), 0.5, 2, assignment1.getID());
		final Task task12 = new Task("Task2 in " + assignment1.getName(), 0.25, 3, assignment1.getID());
		final Task task13 = new Task("Task3 in " + assignment1.getName(), 0.25, 4, assignment1.getID());
		...
		final Task task21 = new Task("Task1 in " + assignment2.getName(), 0.5, 5, assignment2.getID());
		final Task task22 = new Task("Task2 in " + assignment2.getName(), 0.5, 6, assignment2.getID());
		...
		final Task task31 = new Task("Task1 in " + assignment3.getName(), 0.25, 7, assignment3.getID());
		final Task task32 = new Task("Task2 in " + assignment3.getName(), 0.25, 8, assignment3.getID());
		final Task task33 = new Task("Task3 in " + assignment3.getName(), 0.25, 9, assignment3.getID());
		final Task task34 = new Task("Task4 in " + assignment3.getName(), 0.25, 10, assignment3.getID());
	...
	public void updateAssignments() {
		...
		final Task task11 = new Task("Task1 in " + assignment1.getName(), 0.5, 1, assignment1.getID());
		final Task task12 = new Task("Task2 in " + assignment1.getName(), 0.25, 2, assignment1.getID());
		final Task task13 = new Task("Task3 in " + assignment1.getName(), 0.25, 3, assignment1.getID());
		assignment1.addTask(task11);
		assignment1.addTask(task12);
		assignment1.addTask(task13);
		
		final Assignment assignment2 = new Assignment("Assignment 2", new Date(), template1);
		final Task task21 = new Task("Task1 in " + assignment2.getName(), 0.5, 4, assignment2.getID());
		final Task task22v1 = new Task("Task2v1 in " + assignment2.getName(), 0.25, 5, assignment2.getID());
		final Task task22v2 = new Task("Task2v2 in " + assignment2.getName(), 0.25, 6, assignment2.getID());
		final Task task23 = new Task("Task3 in " + assignment2.getName(), 0.25, 7, assignment2.getID());
		assignment2.addTask(task21);
		assignment2.addTask(task22v1);
		
		final Assignment assignment3 = new Assignment("Assignment 3", new Date(), template1);
		final Task task31 = new Task("Task1 in " + assignment3.getName(), 0.25, 8, assignment3.getID());
		final Task task32 = new Task("Task2 in " + assignment3.getName(), 0.25, 9, assignment3.getID());
		final Task task33 = new Task("Task3 in " + assignment3.getName(), 0.25, 10, assignment3.getID());
		final Task task34 = new Task("Task4 in " + assignment3.getName(), 0.25, 11, assignment3.getID());
		assignment3.addTask(task31);
		assignment3.addTask(task32);
		assignment3.addTask(task33);
		assignment3.addTask(task34);
	...
	public void getAllAssignments() {
		...
		final Task task21 = new Task("Task1 in " + assignment2.getName(), 0.5, 4, assignment2.getID());
		final Task task22 = new Task("Task2 in " + assignment2.getName(), 0.5, 5, assignment2.getID());
		assignment2.addTask(task21);
		assignment2.addTask(task22);
		
		final Assignment assignment3 = new Assignment("Assignment 3", new Date(System.currentTimeMillis()
			+ (86400 * 1000) * 12), template);
		final Task task31 = new Task("Task1 in " + assignment3.getName(), 0.25, 6, assignment3.getID());
		final Task task32 = new Task("Task2 in " + assignment3.getName(), 0.25, 7, assignment3.getID());
		final Task task33 = new Task("Task3 in " + assignment3.getName(), 0.25, 8, assignment3.getID());
		final Task task34 = new Task("Task4 in " + assignment3.getName(), 0.25, 9, assignment3.getID());
		assignment3.addTask(task31);
		assignment3.addTask(task32);
		assignment3.addTask(task33);
		assignment3.addTask(task34);
